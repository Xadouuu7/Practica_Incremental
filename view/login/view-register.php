...
<body>
    ...
    ?>
    <form action="../../controller/login/controller-register.php" method="post" accept-charset="UTF-8" class="max-w-sm mx-auto">
        <div class="mb-5">
        ...
        <div class="mb-5">
            ...
            <input type="text" id="nombre" name="nombre" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 light:bg-gray-700 light:border-gray-600 light:placeholder-gray-400 light:text-white light:focus:ring-blue-500 light:focus:border-blue-500" placeholder="Nombre" required  />
            <ul class="mt-2 text-xs text-gray-600">
        ...
        <div class="mb-5">
            <label for="apellidos" class="block mb-2 text-sm font-medium text-gray-900 light:text-black">Apellidos</label>
            <input type="text" id="apellidos" name="apellidos" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 light:bg-gray-700 light:border-gray-600 light:placeholder-gray-400 light:text-white light:focus:ring-blue-500 light:focus:border-blue-500" placeholder="Apellidos" required  />
            <ul class="mt-2 text-xs text-gray-600">
                <li>• Entre 1 y 50 caracteres</li>
                <li>• Solo letras y espacios</li>
            </ul>
        ...
        <div class="mb-5">
            <label for="correo" class="block mb-2 text-sm font-medium text-gray-900 light:text-black">Correo Electrónico</label>
            <input type="text" id="correo" name="correo" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 light:bg-gray-700 light:border-gray-600 light:placeholder-gray-400 light:text-white light:focus:ring-blue-500 light:focus:border-blue-500" placeholder="Correo Electrónico" required  />
        </div>
        ...
        <div class="mb-5">
            <label for="verificarContraseña" class="block mb-2 text-sm font-medium text-gray-900 light:text-black">Verificar Contraseña</label>
            <input type="password" id="verificarContraseña" name="verificarContraseña" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 light:bg-gray-700 light:border-gray-600 light:placeholder-gray-400 light:text-white light:focus:ring-blue-500 light:focus:border-blue-500" required/>
        </div>
